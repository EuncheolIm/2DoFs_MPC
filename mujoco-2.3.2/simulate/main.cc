...
void PhysicsLoop(mj::Simulate& sim) {
  ...
  // int body_idx = mj_name2id(m, mjOBJ_BODY, "body2");

  // 힘을 계산하고 적용
  mjtNum force[3] = {10.0, 0, 0};
  double applied_force[3] = {10.0, 0.0, 0.0};
        ...
        if (sim.run) {
          ...
          // in-sync: step until ahead of cpu
            ...
            while (Seconds((d->time - syncSim)*slowdown) < mj::Simulate::Clock::now() - syncCPU &&
              ...
              // d->qpos[0] = 30*DEG2RAD;
              // d->qpos[1] = 30*DEG2RAD;
              Control.read(d->time, d->qpos, d->qvel, d->sensordata, m->opt.timestep);
              Control.control();
              Control.write(d->ctrl);

              // cout <<"nbody : "<<m->nbody<< " "<<body_id<<endl;
...
int main(int argc, const char** argv) {
  ...
  // char str[100] = "/home/kist/mujoco-2.3.1/model/franka_emika_panda/panda.xml";
  // char str[100] = "/home/kist/euncheol/test/model/panda/panda.xml";
  // char str[100] = "/home/kist/euncheol/test/model/arm26.xml";
  char str[100] = "/home/kist/euncheol/2dof_mpc/model/arm26.xml";
